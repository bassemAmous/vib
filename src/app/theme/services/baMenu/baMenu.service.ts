...
export class BaMenuService {
 ...
 getPlant() {
         console.log("menu"+this.server)  
    return this.http.get('https://betavib.herokuapp.com/betavib/Plant/'+this.server+'/'+this.user+'/'+this.password+'/'+this.database)
      .map(res => res.json());
  }
getDept() {
    console.log("menu"+this.plant)
    this.plant=sessionStorage.getItem('plant');
    console.log("menu1"+this.plant)
    return this.http.get('https://betavib.herokuapp.com/betavib/Dep/'+this.server+'/'+this.user+'/'+this.password+'/'+this.database+'/'+this.plant)
      .map(res => res.json());
  }

getMachines() {

    return this.http.get('https://betavib.herokuapp.com/betavib/machines/'+this.server+'/'+this.user+'/'+this.password+'/'+this.database)
      .map(res => res.json());
  }
